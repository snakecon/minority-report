...
class Pipeline(object):
    ...
    def run(self):
        ...
        question_block = self.ocr(filename)
        self.print_questions(question_block)
        results = self.rank_answers(question_block)
        index = self.print_answers(results)
        self.touch_button(index)
    ...
    def rank_answers(self, question_block):
        ...
        if sorted_results[0]["count"] == sorted_results[1]["count"]:
            ...
            text = self._google([question, ans_1, ans_2, ans_3], 50)
